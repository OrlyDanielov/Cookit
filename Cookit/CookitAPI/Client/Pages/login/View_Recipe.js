...
function GetProfileName() {
    ...
    GlobalAjax("/api/Profile/GetProfileByUserId/" + _user_id, "GET", "",
        function (data) {
            ...
            ViewRecipeInformation(data.name);
        },
        function () {
...
//מציג את המידע של המתכון
{
    ...
    $("#recipe_picture").attr("src", recp_img_path);
    //מציג את שלבי ההכנה
...
function ShowFavorite() {
    if (LOGIN_USER.id != RECIPE_INFORMATION.user_id)//אם המתכון שיך למשתמש המחובר
    {
        ...
        document.getElementById("div_recipe_favorite").style["display"] = "none";
    }
}
//*******************************************************************************************
// ADD NEW LIKE
...
function ShowRecipeComments() {
    if (RECIPE_COMMENTS.length == 0) {
        ...
        //document.getElementById("old_comment").style["height"] = "50px";
        document.getElementById("old_comment").innerHTML = "אין תגובות";
    }
    else {
        document.getElementById("comments").style["height"] = "500px";
        document.getElementById("comments").style["overflowY"] = "scroll";
        document.getElementById("comments").style["overflowX"] = "hidden";
        //document.getElementById("old_comment").style["height"] = "300px";
...
function AddComment(_comment, user_full_name) {
    COUNT_COMMENT += 1;
    if (COUNT_COMMENT == 0)
        document.getElementById("old_comment").innerHTML = "";
    else {
        document.getElementById("comments").style["height"] = "500px";
        document.getElementById("comments").style["overflowY"] = "scroll";
        document.getElementById("comments").style["overflowX"] = "hidden";
