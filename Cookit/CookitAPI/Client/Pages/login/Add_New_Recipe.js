...
function AddRecipeImage() {
    //var recipe_image_name = $("#recipe_upload_image").val();
    //var arry = recipe_image_name.split('\\');
...
function SuccessAddHolidayForRecipe() {
    ...
    window.location.replace("View_Recipe.html"); //מעבר לדף הבית המחובר
}
